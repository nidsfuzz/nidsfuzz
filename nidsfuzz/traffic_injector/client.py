...
class EchoClient(Client):
    ...
    def send(self, data, *args, **kwargs):
        ...
        if data is None or data == b"":
            _echo_msg = pickle.dumps(EchoMessage(receive=_receive, reflect=_reflect), protocol=2)
        else:
            _echo_msg = pickle.dumps(EchoMessage(receive=_receive, reflect=True, data=data), protocol=2)
