...
class BufferConstructor(abc.ABC):
    """
    This class provides the most basic option push methods, which are generally only applicable to
    the simplest scenarios, where the options in a Rule are assembled together based on their corresponding
    sticky buffers.

    "Push an option into the buffer unstrictly" means relatively positioning the option into the buffer.
    """
